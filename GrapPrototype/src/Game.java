...
public class Game extends JComponent implements Runnable, Dumpable {
	...
	static {
		...
		PlayersInitParams[0] = new PlayerInitParams(p1Control,"robot/p1Rob.png",new Vector2D(600,594));
		...
		PlayersInitParams[1] = new PlayerInitParams(p2Control,"robot/p2Rob.png",new Vector2D(600,532));
	}
	...
	private Vector2D getRandomOnMapPostition()
	{
		...
		do
		{
			pos = new Vector2D(Math.random()*map.getWidth(),Math.random()*map.getHeight());
